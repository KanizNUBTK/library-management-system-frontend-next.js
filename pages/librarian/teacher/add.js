        ...
        async function createMember() {
            try {
                ...
                if (response.data.status === true) {
                    swalAlert.success('New Teacher Added Successfully!');
                    setTimeout(() => {
                        router.push('/librarian/teacher/view-all')
                    }, 3000);
                }
    ...
    return (
        <Layout>
            <div className='bg-slate-300 h-screen rounded-md p-0 m-0'>
                <h1 className='text-center py-4 font-semibold text-lg text-cyan-800'>Add A New Teacher</h1>
